...
export default class Solicitud extends Base {
	...
	//this.setRechazar = () => this.setEstado(2); // marca la solicitud como rechazada
	...
	//this.setCancelar = () => this.setEstado(7); // marca la solicitud como cancelada
