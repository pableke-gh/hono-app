...
class Bancks extends Msgs {
	...
	getEntidades = () => BankNames;
	getIban1 = iban => iban && iban.substring(0, 4);
	getIban2 = iban => iban && iban.substring(4, 8);
	getEntidad = iban => BankNames[this.getIban2(iban)];
	getIban3 = iban => iban && iban.substring(8, 12);
	getOficina = iban => iban && iban.substring(8, 12);
	getDC = iban => iban && iban.substring(12, 14);
