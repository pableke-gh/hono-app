...
function Organica() {
	...
	this.row = data => {
        ...
        const user = /*buzon.isPermisoUser()*/(1==1) ? '<a href="#users" class="action resize text-purple row-action" title="Gestión de permisos"><i class="fas fa-user"></i></a>' : ""; //TODO: change class for complete link
