...
import Solicitudes from "../../../core/components/tables/solicitudes.js";
...
export default class IrseSolicitudes extends Solicitudes {
	...
	row(data) {
		...
		return `<tr class="tb-data">
			...
			<td class="${irse.getStyleByEstado()} table-reload" data-reload="update-estado">${irse.getDescEstado()}</td>
