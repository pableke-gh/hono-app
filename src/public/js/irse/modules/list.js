...
function List() {
	...
	tabs.setAction("zip-com", () => api.setZip().blob("/uae/iris/zip/com").then(data => api.download(data, "iris-facturas.zip")));
	tabs.setAction("zip-doc", () => api.setZip().blob("/uae/iris/zip/doc").then(data => api.download(data, "iris-doc.zip")));
}
